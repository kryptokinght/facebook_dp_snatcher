...
function PromiseAccumulator(accumulator, name) {
	...
	return nightmare
	  ...
	  .then(function(result){
	    ...
	    results.push(person);
	    completed.push(name);
		fs.writeFile('female_final2.txt', JSON.stringify(results), (err) => {
			console.log(err);
		});
	    return results;
	  });
